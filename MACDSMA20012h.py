...
class MACDSMA20012h(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (dataframe['close'] > dataframe['sma400']) &
                (dataframe['volume'] > 0)
            ),
            'enter_long'] = 1
    ...
    # freqtrade backtesting --strategy MACDSMA20012h --timeframe 12h --timerange 20190909-20221111 --export trades
    # ni profita v shortanju