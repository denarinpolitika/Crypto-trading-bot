...
class DoubleEMACrossoverWithTrend(IStrategy):
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        return dataframe
    # freqtrade backtesting --export trades -s DoubleEMACrossoverWithTrend -p BTC/USDT ETH/USDT XMR/USDT LTC/USDT --timeframe 6h --timerange=20180301-20200301
    # plotej pa poglej zakaj je cum profit tok visok tot profit pa tok low
    # DONT WORK
